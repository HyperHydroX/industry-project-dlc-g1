  ...
  >
    <div class="CodeInput">
      ...
      <template v-for="(v, index) in values" :key="index">
        <input
          class="Input w-14 h-14 rounded-lg border border-primary outline-none focus:outline-none focus:border-primary focus:ring-0 text-center transition-all"
          type="number"
          pattern="[0-9]"
          :style="{
